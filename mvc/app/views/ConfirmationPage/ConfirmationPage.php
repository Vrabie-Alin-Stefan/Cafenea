...
<html lang="ro">
	<head>
		...
		<link rel="stylesheet" href="http://localhost/www.httpcafe.com/css/ConfirmationPage1.css">
	...
	<body>
			...
			<div id = "photo1"></div>
						...
						<br>
                                ...
                                va veni cineva sa va aduca bautura/prajitura dorita!
                        </div>
                        <div id = "photo2"></div>
                    </div>
                    <div class = "item">
                        <input type="button" class="button" value="Nota" onclick="location.href = 'http://localhost/www.httpcafe.com/confirmation/modal';">
